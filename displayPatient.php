...
<div class="container">
    ...
    <form action="deletePatient.php" method="POST">
        <table border='1' align='center' class='table table-hover text-center'>
            <caption align='center' style='color:#2E4372'><h3 class="text-center"><u>Delete Patient</u></h3></caption>
            ...
            if(isset($_POST['search'])){
                ...
                if($rows==0)
                {
                    header('Location:SearchPatientToDelete.php');
       ...
       <h3 class="text-center"><button type="submit" name="delete" class="btn btn-danger">Delete</button></h3>
