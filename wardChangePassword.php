...
if(isset($_SESSION['logInWard']) && isset($_POST['changePassword'])) {
    $username = $_SESSION['logInWard'];
...
//        echo "Fail";
    ...
    $oldPasswordQuery = "SELECT PASSWORD FROM Staff WHERE USERNAME='" . $_SESSION['logInWard'] . "'";
...
//        echo "<br>";
        ...
        if ($hashOld ==$oldPassArray)
        {
            ...
            {
                $insertNewPassword = "UPDATE  Staff SET PASSWORD='$hashNew' WHERE  USERNAME='" . $_SESSION['logInWard'] . "'";
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="wardChangePassword.php" method="POST">
