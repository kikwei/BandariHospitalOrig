...
if(isset($_SESSION['logInReceptionist']) && isset($_POST['changePassword'])) {
...
//        echo "Fail";
    ...
    $username = $_SESSION['logInReceptionist'];
    $oldPasswordQuery = "SELECT PASSWORD FROM Staff WHERE USERNAME='" . $_SESSION['logInReceptionist'] . "'";
...
//        echo "<br>";
        ...
        if ($hashOld ==$oldPassArray)
        {
            ...
            {
                $insertNewPassword = "UPDATE  Staff SET PASSWORD='$hashNew' WHERE  USERNAME='" . $_SESSION['logInReceptionist'] . "'";
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="receptionistChangePassword.php" method="POST">
