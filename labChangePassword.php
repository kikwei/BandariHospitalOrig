...
if(isset($_SESSION['logInLabTech']) && isset($_POST['changePassword']))
{
    $username = $_SESSION['logInLabTech'];
...
//        echo "Fail";
    ...
    $oldPasswordQuery = "SELECT PASSWORD FROM Staff WHERE USERNAME='" . $_SESSION['logInLabTech'] . "'";
...
//        echo "<br>";
        ...
        if ($hashOld ==$oldPassArray)
        {
            ...
            {
                $insertNewPassword = "UPDATE  Staff SET PASSWORD='$hashNew' WHERE  USERNAME='" . $_SESSION['logInLabTech'] . "'";
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="labChangePassword.php" method="POST">
